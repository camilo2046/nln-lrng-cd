...
var prod_obj = db.products.findOne( { _id : ObjectId("507d95d5719dbef170f15c00") } );
prod_obj["term_years"] = 3;
prod_obj.limits.sms.over_rate = 0.01;

db.products.update ({ _id : ObjectId("507d95d5719dbef170f15c00") }, prod_obj);
